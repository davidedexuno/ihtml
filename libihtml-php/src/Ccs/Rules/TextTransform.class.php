...
class TextTransformRule extends BaseRule
{
    public static function rule():      string { return 'text-transform'; }
    public static function method():    string { return 'textTransform';  }
    public static function constants(): array  { return parent::constants() + [
