...
class WhiteSpaceModifier extends LateInheritedModifier {
	...
	function queryMethod(): string { return 'whiteSpace'; }
	
	function isValid(...$params): bool { return in_array($params[0], [self::NORMAL, self::NOWRAP, self::PRE, self::PRELINE, self::PREWRAP, self::INHERIT]); }
